...
We've identified several product gaps in the existing product line includingL
...
1. Trigger, over Mountain with Aluminum Frame: $3,258

2. Slice, Triathalon with Aluminum Frame: $2,662
...
The visualisation segments the full bicycle product line by category and frame material. This exposes two product gaps:

1. New __Aluminum__ line of bikes in the __Over Mountain__ category.

2. New __Aluminum__ line of bikes in the __Triathalon__ category.

```{r, out.height="600px"}
plot_bike_features(interactive = params)
```
